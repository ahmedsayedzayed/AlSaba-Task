...
@Directive({
    selector: '[appSideNavWatchHeight]'
})
export class WatchHeighSideNavtDirective implements OnInit, AfterViewChecked, OnDestroy {
    ...
    ngAfterViewChecked(): void {
        const t = document.body.clientHeight - this.el.nativeElement.getBoundingClientRect().top;
        this.renderer.setStyle(this.el.nativeElement, 'height', (t-50) + 'px');
    }
